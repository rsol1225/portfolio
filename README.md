...
Every time you run the script it reads from templates/, fills in the values from content.json, and writes the result to the root, so my placeholders are always safe.
